...
import { RButton, ShopNowBtn } from "../../components/buttons/Button";
    ...
    <>
      ...
      <main>
        <section className='landing container'>
          ...
          <h1 className='landing__hero'>
            Welcome to <br></br>Covape-19 Garage
          </h1>
          <Link to='/dashboard'>
            <RButton className='banner_shop_now' displayText='Shop Now' />
          </Link>
        </section>
        ...
        <section className='landing__choose container section'>
          ...
          <div className='choose__wrapper subtitle'>
            ...
            <p className='landing__description'>
              Experience the finest quality vaping products handpicked by vaping enthusiasts.
            </p>
        ...
        <section className='landing__getstart container section'>
          ...
          <p className='landing__description'>
            Don’t waste another moment – elevate your vaping game today! <br></br>Join us and experience the ultimate in
            premium vaping bliss.
          </p>
          <Link to='/dashboard'>
            <ShopNowBtn displayText='Shop Now' />
          </Link>
        </section>
